window.dashMap = window.dashMap || (function (environment) {
  ...
  return [ function (state) {
    ...
    CREAM[ state.context.mapid ] = this.isArray(state.context.map) ? state.context.map : [state.context.map];
    ...
    if (this.exists(state.context.entry)) {
	    var deferred = this.deferred(),
	    	...
	    	promises = [],
	    	that = this;
	    this.each(CREAM[ state.context.mapid ], function(fn) {
	    ...
	    delete CREAM[ state.context.mapid ];
