window.dashStats = window.dashStats || (function (environment) {
  ...
  return function (state) {
    ...
    console.log('stats', state.context.statistics, state.context.statistics.request.expected[noun], state.context.statistics.request.requests[noun], JSON.stringify(state.context.statistics.request.remaining));
    return state;
  };
}(self));