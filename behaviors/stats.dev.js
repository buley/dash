  ...
  return function (state) {
    var context = state.context,
      ...
      calculate = function(v, n) {
        ...
        console.log(state.context.statistics.request.metrics[v].rate, state.context.statistics.request.metrics[v].rate, state.context.statistics.request.metrics.total.rate);
      };
