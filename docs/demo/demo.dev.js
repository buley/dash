var IMDBSystem = (function(THREE){        
	...
	return function(node, width, height, cb) {
		    ...
		    scene.add( light );
	            var bounding = new THREE.CubeGeometry( range, range, range, 16, 16, 16 ),
			bounding_material = new THREE.MeshBasicMaterial( {color: 0x555555, wireframe: true, transparent: false, opacity: .1 } ),
