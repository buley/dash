        ...
        return function link(scope, element, attrs) {
          var statsObj = {},
            ...
            (function (context) {
              ...
              console.log('yes we did',JSON.stringify(context.statistics.request));
          ...
          var last_time = new Date().getTime(),
            ...
            statsFunc = function () {
              ...
              if ( !statsObj || true === statsObj.clear ) {
                ...
                scope.statsDisplay.total = statsObj.request.metrics.expected.total;
                scope.statsDisplay.complete = statsObj.request.metrics.requests.total;
